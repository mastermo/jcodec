...
public class ProresEncoder {
    ...
    public ByteBuffer encodeFrame(ByteBuffer _out, Picture... pics) {
        ...
        writeFrameHeader(out, new ProresConsts.FrameHeader(0, pics[0].getWidth(), pics[0].getHeight() * pics.length,
                pics.length == 1 ? 0 : 1, true, scan, profile.qmatLuma, profile.qmatChroma));
