...
public class Intra16x16PredictionBuilder {
    ...
    public static void predictWithMode(int predMode, int[] residual, boolean leftAvailable, boolean topAvailable,
            int[] leftRow, int[] topLine, int x) {
        switch (predMode) {
        case 0:
            predictVertical(residual, leftAvailable, topAvailable, leftRow, topLine, x);
            break;
        case 1:
            predictHorizontal(residual, leftAvailable, topAvailable, leftRow, topLine, x);
            break;
        case 2:
            predictDC(residual, leftAvailable, topAvailable, leftRow, topLine, x);
            break;
        case 3:
            predictPlane(residual, leftAvailable, topAvailable, leftRow, topLine, x);
            break;
        }
