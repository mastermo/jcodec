...
public class PictureParameterSet extends BitstreamElement {
    ...
    public static PictureParameterSet read(ByteBuffer is) {
        ...
        pps.num_ref_idx_l0_active_minus1 = readUE(in, "PPS: num_ref_idx_l0_active_minus1");
        pps.num_ref_idx_l1_active_minus1 = readUE(in, "PPS: num_ref_idx_l1_active_minus1");
    ...
    public void write(ByteBuffer out) {
        ...
        writeUE(writer, num_ref_idx_l0_active_minus1, "PPS: num_ref_idx_l0_active_minus1");
        writeUE(writer, num_ref_idx_l1_active_minus1, "PPS: num_ref_idx_l1_active_minus1");
