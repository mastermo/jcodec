...
public class CAVLC {
    ...
    public void readLumaDCBlock(BitReader reader, int[] coeff, int mbX, boolean leftAvailable, boolean topAvailable,
            int[] zigzag4x4) {
        VLC coeffTokenTab = getCoeffTokenVLCForLuma(leftAvailable, tokensLeft[0], topAvailable, tokensTop[mbX << 2]);
