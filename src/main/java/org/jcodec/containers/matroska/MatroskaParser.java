...
import org.jcodec.containers.matroska.ebml.BinaryTag;
import org.jcodec.containers.matroska.ebml.EBMLException;
import org.jcodec.containers.matroska.ebml.FixedSizeInputStream;
import org.jcodec.containers.matroska.ebml.RootTag;
import org.jcodec.containers.matroska.ebml.StringTag;
import org.jcodec.containers.matroska.ebml.Tag;
import org.jcodec.containers.matroska.ebml.TagType;
import org.jcodec.containers.matroska.ebml.UIntTag;
        ...
        if (!tagStack.isEmpty()) {
            ...
            if (nextTag != null) {
                ...
                if (nextTag.getType() == TagType.TYPE_BINARY) {
                    ...
                    if (MatroskaDocument.getTagName(bt.id) == "ClusterBlock"
                            || MatroskaDocument.getTagName(bt.id) == "ClusterSimpleBlock") {
                        hasTracks = true;
