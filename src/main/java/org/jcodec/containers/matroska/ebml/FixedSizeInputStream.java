 ...
 * 
 * FixedSizeInputStream extends InputStream to prevent over-reading.
 * 
...
public class FixedSizeInputStream extends InputStream {
    ...
    public int available() {
        if ((inputStreamSize == -1) || (inputStreamSize - usedBytes > Integer.MAX_VALUE))
