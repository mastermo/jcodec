 ...
 * 
 * Takes care of the business of reading EBML bitstreams and returns correctly
 * formed Tags.
 * 
...
public class EBMLReader {
    ...
    /*
     * TODO : Probably the wrong place for this. Reading the MatroskaDocument in
     * package org.jcodec.containers.matroska is not very nice structure as EBML
     * reading is a useful tool in its own right, and should not be tied like
     * this to Matroska.
     */
