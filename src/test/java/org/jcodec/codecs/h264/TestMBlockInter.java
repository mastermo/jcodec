...
public class TestMBlockInter extends JAVCTestCase {
    ...
    public void testMB8x16() throws Exception {
        ...
        CoeffToken[] lumaTop = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                new CoeffToken(0, 0),

                new CoeffToken(1, 1), new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(1, 1),

                new CoeffToken(3, 3), new CoeffToken(2, 2), new CoeffToken(1, 1), new CoeffToken(1, 1) };

        CoeffToken[] cbTop = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                new CoeffToken(0, 0) };

        CoeffToken[] crTop = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                new CoeffToken(0, 0) };

        // MB 38
        CoeffToken[] lumaLeft = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                new CoeffToken(0, 0),

                new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(1, 1), new CoeffToken(1, 0),

                new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),

                new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(1, 1), new CoeffToken(0, 0) };
    ...
    public void testMB16x8() throws Exception {
        ...
        CoeffToken[] lumaLeft = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                ...
                new CoeffToken(2, 2), new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(1, 1),

                new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(0, 0), new CoeffToken(1, 1) };
    ...
    public void testMB16x16() throws Exception {
        ...
        CoeffToken[] lumaTop = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),
                ...
                new CoeffToken(2, 2), new CoeffToken(1, 0), new CoeffToken(0, 0), new CoeffToken(0, 0),

                new CoeffToken(2, 2), new CoeffToken(0, 0), new CoeffToken(0, 0), new CoeffToken(0, 0) };
        ...
        // MB 71
        CoeffToken[] lumaLeft = new CoeffToken[] { new CoeffToken(0, 0), new CoeffToken(1, 1), new CoeffToken(3, 2),
                new CoeffToken(0, 0),

                new CoeffToken(1, 1), new CoeffToken(1, 1), new CoeffToken(0, 0), new CoeffToken(1, 1),

                new CoeffToken(4, 3), new CoeffToken(2, 0), new CoeffToken(1, 1), new CoeffToken(1, 0),

                new CoeffToken(1, 1), new CoeffToken(1, 0), new CoeffToken(2, 1), new CoeffToken(2, 1) };
